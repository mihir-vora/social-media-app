...
class UserPostListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # count the total number post of each user
        post_count = Post.objects.filter(author=visible_user)
        countUserPost = post_count.count()

        data['user_profile'] = visible_user
        data['can_follow'] = can_follow
        data['count_post'] = count_post
        data['countUserPost'] = countUserPost
        return data
...
class FullPostsDetailView(DetailView):
    model = Post
    template_name = 'blog/id_wise_posts_details.html'
    context_object_name = 'post'
